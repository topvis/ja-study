...
<table :class="$style['verb-conjugation-table']">
  ...
  <tr>
    ...
    <th colspan="3" style="text-align: center;">动1<br />
    （五段动词）</th>
    <th colspan="3" style="text-align: center;">动２<br />
    （一段动词）<br />
    イ段+る， エ段+る</th>
    <th colspan="3" style="text-align: center;">动3<br />
    （サ变：する，カ变：来る）</th>
  </tr>
  </thead>
  <tbody>
  <tr style="border-bottom: 2px solid #666"></tr>
  <tr>
  <th rowspan="9"><strong>ます形</strong></th>
  ...
  <tr style="border-bottom: 2px solid #666"></tr>
  <tr>
    <th rowspan="9"><strong>て形</strong></th>
    <td><strong>～う</strong></td>
    <td>→</td>
    <td>～って</td>
    <td>～る</td>
  ...
  <tr style="border-bottom: 2px solid #666"></tr>
  <tr>
  <th rowspan="9"><strong>た形</strong></th>
    <td><strong>～う</strong></td>
    <td>→</td>
    <td>～った</td>
    <td>～る</td>
  ...
  <tr style="border-bottom: 2px solid #666"></tr>
  <tr>
    <th rowspan="9"><strong>ない形</strong></th>
    <td><strong>～う</strong></td>
    <td>→</td>
    <td>～<strong>わ</strong>ない</td>
    <td>～る</td>
    <td>→</td>
    <td><del>ます</del>形＋ない</td>
    <td>来る</td>
    <td>→</td>
    <td>ない</td>
  </tr>
